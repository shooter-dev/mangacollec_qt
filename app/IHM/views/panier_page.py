...
class PanierPage(PageInterface, AbstractPage):
    ...
    def modify_widgets(self) -> Any:
        self.label.setText("Panier Page")
    ...
    def update_page(self):
        print('Panier Page update')
        self.label.setText(self.get_param("test") + " " + str(self.get_param("number")))
